...
exports.hexaTrapper = makeAuto({
        ...
        GUNS: [
            ...
            {
                POSITION: [12, 8, 1, 0, 0, 60, 0.5],
            },
            {
                POSITION: [5, 8, 1.8, 12, 0, 60, 0.5],
                PROPERTIES: {
                    SHOOT_SETTINGS: combineStats([g.trap, g.hexatrap]),
                    TYPE: "trap",
                    STAT_CALCULATOR: gunCalcNames.trap,
            ...
            {
                POSITION: [12, 8, 1, 0, 0, 300, 0.5],
            },
            {
                POSITION: [5, 8, 1.8, 12, 0, 300, 0.5],
                PROPERTIES: {
                    SHOOT_SETTINGS: combineStats([g.trap, g.hexatrap]),
                    TYPE: "trap",
                    STAT_CALCULATOR: gunCalcNames.trap,
...
exports.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "uzi", "lancer", "heatseeker", "angleTri"/* "whirlwind"*/];
    ...
    exports.machineGun.UPGRADES_TIER_2 = ["artillery", "minigun", "gunner", "sprayer", "nucleus", "flankMachineGun"];
        ...
        exports.flankMachineGun.UPGRADES_TIER_3 = ["pullingWell"];
            exports.pullingWell.UPGRADES_TIER_3 = ["gravityWell", "draggingSkill", "tugger"];
